...
<div id="wrapper_sec">
	<div id="head">
	  <div class="logo">
        	<a href="index.php"><img src="images/logo2.png" alt="" style="height: 80px;"/></a>
      </div>
        <div class="rightnavi">
           <?php 	
  session_start();
...
<span style='color:white; margin-left:150px;;font-size:13px;'>
  Nama Anggota :$_SESSION[nama]
  </span></br>
  
  <span ><a href='logout.php' style='color:white; margin-left:230px;;font-size:13px;'>Logout</a></span> ";
 ?>
...
?>
    ...
    <div id="footer">
        <div class="aboutus">
        	<h5>Tentang Kami</h5>
        	<p>
            	Kami menyediakan berbagai macam jenis pakaian bekas. Toko kami memiliki tempat yg lengkap dan komplit untuk berbelanja berbagai macam pakaian bekas. Kenyamanan dan keamanan pun kami jaga sehingga tercipta hubungan baik penjual dan pembeli.
Selamat berbelanja. </p>
        ...
        <div class="contactus">
       	  <h5>Kontak Kami </h5>
            <ul>
            	<li class="tel"><span class="bold">Tel:</span> 081238620079 </li>
                <li class="email"><span class="bold">Email:</span> elgasi057@gmail.com</li>
            </ul>
        </div>
        <div class="clear"></div>
...
<div style="display: none;">
    ...
    <ul class="forms">
        ...
        <li class="inputfield"><input type="text" name="txt_nama" value="" class="bar" /></li>
    </ul>
    <ul class="forms">
    	<li class="txt">Password</li>
        <li class="inputfield"><input type="password" name="txt_pass" value="" class="bar" /></li>
    </ul>
    <ul class="forms marg_top">
    	<li class="txt"><input type="submit" value="Login" class="simplebtn"/>&nbsp;&nbsp; <a href="#" class="simplebtn">Batal</a></li>
    </ul>
	</form>
		</div>
    ...
    <script type="text/javascript">
<!--
	$('#telpon').keypress(function(event) {
