 	...
 	if ($d[gambar]!=''){
		echo "<div class='prod_img3'><a href='foto_produk/$d[gambar]' rel='clearbox[gallery=Koleksi Produk]' title='$d[nama_produk]'<img src='foto_produk/$d[gambar]' width=180  class='tooltip' title='klik untuk memperbesar gambar' border='0' rel='clearbox[gallery=Koleksi Produk]' title='$d[nama_produk]'/></a>
            ...
            <div class='details'>$d[deskripsi]</div><br />
                    ...
                    <div class='table6'>&bull; STOK:<span class='table7'> $d[stok] </span></div>
                     <div class='table6'>&bull; Berat:<span class='table7'> $d[berat] </span></div><br />
...
if ($_GET['module']=='profilkami'){
  ...
  <?php
          ...
          <div class='profil'>
			  ...
			  ?>
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.057185813136!2d106.84465041392613!3d-6.256197164967909!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f3edf803edd5%3A0x247e273900cae619!2skost%20pak%20karpo!5e0!3m2!1sen!2sid!4v1644444630189!5m2!1sen!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
<?php
          echo"</div>    
          </div>
          </div>";                             
...
elseif ($_GET[module]=='keranjangbelanja'){
  ...
  if($ketemu < 1){
    ...
    echo "<h4 class='heading colr'>Keranjang Belanja</h4>
          ...
          <tbody>
         <tr  background='images/bg_tab.jpg' align=center height=23><th><span class='table'>No</th><th><span class='table'>Produk</th>
         <th><span class='table'>Nama Produk</th><th><span class='table'>Qty(m)</th>
  ...
  echo "<tr><td colspan=6 align=right><br><span class='table3'>Total:</td><td colspan=2><br><span class='table3'>Rp. $total_rp,-</b></td></tr>
        <tr><td colspan=2><br /><a href=http://localhost/baju.com/semua-produk.html style='width: 135px; height: 18px;'  class= simplebtn>LANJUTKAN BELANJA</a><br /></td>
        <td colspan=2><br /><input style='width: 130px; height: 22px;' type=submit  class= simplebtn value='UPDATE KERANJANG'><br /></td>
        <td colspan=4 align=right><br /><a href='selesai-belanja.html'  class= simplebtn type='submit'>SELESAI BELANJA</a><br /></td></tr>
        </tbody>
  </table>";
echo "<br /><br /><br /><br /><p>*   Apabila Anda mengubah jumlah (Qty (m)), jangan lupa tekan tombol <b>Update Keranjang</b><br />
...
if ($_GET['module']=='konfirmasibayar'){
    
include "config/koneksi.php"; 

?>

 <h4 class="heading colr">Data Konfirmasi Bayar</h4>
<form name="form" action="" method="POST" enctype="multipart/form-data" onSubmit="return validasi(this)">
    <table width="650">
        <tr>
            <td><span class="table4">ID ORDER</td>
            <td> <input type="text" name="idorder" size="30" class="table5"></td>
        </tr>
        <tr>
            <td><span class="table4">Upload Bukti</td>
            <td> <input type="file" name="txtbukti" size="30" class="table5"></td>
        </tr>

        <tr>
            <td colspan=2><input style="width: 120px; height: 25px;" type="submit" name="submit" class="simplebtn" value="Simpan Data"></td>
        </tr>
    </table>
...
<?php                               
    ...
    $nama_file=$_FILES['txtbukti']['name'];
	$ukuran=$_FILES['txtbukti']['size'];
    $url='bukti/';
    
    move_uploaded_file($_FILES['txtbukti']['tmp_name'], "$url".$nama_file);
       $Update = mysql_query("update orders set bukti_b='$nama_file' where id_orders='$ido'"); 
...
session_start();
  ...
  echo "<h4 class='heading colr'>Data Pembeli</h4>
      ...
      <table width=650>
      <tr><td><span class='table4'>Nama</td><td>  <input type=text  name=nama value='$_SESSION[nama]' size=30 class='table5'></td></tr>
      <tr><td><span class='table4'>Alamat Lengkap</td><td>  <input type=text  value='$_SESSION[alamat]' name=alamat size=70 class='table5'></td></tr>
      <tr><td><span class='table4'>Telpon/ HP</td><td>  <input type=text  value='$_SESSION[hp]' name=telpon id=telpon class='table5'></td></tr>
      <tr><td><span class='table4'>Email</td><td>  <input type=text  value='$_SESSION[email]' name=email class='table5'></td></tr>
     ...
     echo "<h4 class='heading colr'>Konfirmasi Keranjang Belanja Anda</h4>
          <table width=670 border=0 cellpadding=0 cellspacing=1 align=center>
          <tbody>
          <tr background='images/bg_tab.jpg' align=center height=23><th><span class='table'>No</th><th><span class='table' >Nama Produk</th>
          <th><span class='table'>Qty(m)</th>
...
//END nampilkan diskon per produk --
  ...
  echo "<tr><td colspan=2 align=right><span class='table3'></td><td align=center><span class='table3'></b></td>
            <td align=right colspan=1><span class='table3'>Total Harga:</td><td align=center><span class='table3'>Rp. $total_rp,-</td></tr>
...
if (empty($_POST[nama]) || empty($_POST[alamat]) || empty($_POST[telpon]) || empty($_POST[email]) || empty($_POST[kota])){
  echo "Data yang Anda isikan belum lengkap<br />
  	    <a href='daftar.php'><b>--Ulangi Lagi--</b>";
}
...
for ($i = 0; $i < $jml; $i++){
  ...
  mysql_query("UPDATE produk SET stok=stok-{$isikeranjang[$i]['jumlah']} WHERE id_produk={$isikeranjang[$i]['id_produk']}");
}
...
echo "<table width=600 border=0 cellpadding=0 cellspacing=1 align=center>
        <tr background='images/bg_tab3.jpg' align=center height=23><th><span class='table'>No</th><th><span class='table'>Nama Produk</th>
        <th><span class='table'>Qty(m)</th><th><span class='table'>Harga</th><th><span class='table'>Sub Total</th></tr>";
...
$total3=$total+$ongkoskirim1;

$grandtotal    = $total + $ongkoskirim; 

$ongkoskirim_rp = format_rupiah($ongkoskirim);
$ongkoskirim1_rp = format_rupiah($ongkoskirim1); 
$grandtotal_rp  = format_rupiah($total3);  
...
mail("rodianto@gmail.com",$subjek,$pesan,$dari);

echo "<tr><td colspan=5 align=right>Total : Rp. </td><td align=right><b>$total_rp</b></td></tr>
      <tr><td colspan=5 align=right>Ongkos Kirim untuk Tujuan Kota Anda: Rp. </td><td align=right><b>$ongkoskirim1_rp</td></tr>      
